...
from .views import EmailVerificationView, RegistrationCreateView, \
                                        UserLoginView, RedPasswordResetView, \
                                        RedPasswordResetDoneView, RedPasswordResetConfirmView, RedPasswordResetCompleteView
